...
## Determinants and signed volume
...
Its magnitude is the area of the parallelogram formed by the columns of $\mathbf A$. For $\mathbf A=[\mathbf a_1\;\mathbf a_2\;\mathbf a_3]\in\mathbb R^{3\times3}$, the determinant is the scalar triple product
