...
The norm introduced in Section 1.3 can equivalently be defined from the dot
...
### 2.2 Identity, transpose, null space, rank, and inverse
...
## 3. Determinants and signed volume

### 3.1 What the determinant measures
