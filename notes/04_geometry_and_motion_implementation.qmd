# Geometry and Motion Implementation

## Purpose and scope

This companion translates the reviewed differential-drive mathematics into reusable software contracts, invariants, validation rules, and tests. The mathematical derivations remain in the kinematics and numerical-integration chapter; this chapter records how those equations map into dependable software.

## 1. Wheel-to-body velocity mapping
...
## 2. Body-to-wheel velocity mapping
...
## 3. Exact constant-input pose integration
...
## 4. Forward Euler pose integration
