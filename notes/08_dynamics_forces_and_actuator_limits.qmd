...
The reader should understand vectors and units from the [linear algebra foundations chapter](01_linear_algebra_foundations.qmd), coordinate frames from the [geometry chapter](02_geometry_and_coordinate_frames.qmd), and derivatives and numerical integration from the [kinematics and numerical integration chapter](03_kinematics_and_numerical_integration.qmd).
...
### 1.3 Newton's second law and the forward-dynamics equation
...
### 1.4 Constant-force motion over one interval
...
### Quick test A answers and hints
...
## 2. From motor torque to wheel traction

### 2.1 Torque and its units
...
### 2.2 The wheel rotational balance
...
### 2.3 Combining the two drive wheels
...
### Quick test B answers and hints
